...
Ready-to-use example configs for popular models are in the [`examples/`](_media/examples) directory:

| File | Model | Notes |
|------|-------|-------|
| [`qwen2.5-instruct.yaml`](_media/qwen2.5-instruct.yaml) | Qwen/Qwen2.5-0.5B-Instruct | Dense 0.5B, single node (minimal example) |
| [`qwen3.6-35b-a3b.yaml`](_media/qwen3.6-35b-a3b.yaml) | Qwen/Qwen3.6-35B-A3B | Hybrid MoE 35B, reasoning, single node |
| [`qwen3.5-long-context.yaml`](_media/qwen3.5-long-context.yaml) | Qwen/Qwen3.5-35B-A3B | Hybrid MoE 35B, long context, single node |
| [`gemma-4-31B-it.yaml`](_media/gemma-4-31B-it.yaml) | google/gemma-4-31B-it | Dense 31B multimodal, single node |
| [`gpt-oss-120b.yaml`](_media/gpt-oss-120b.yaml) | openai/gpt-oss-120b | MoE 117B MXFP4, single node |
| [`nemotron-3-super-120B-A12B-BF16.yaml`](_media/nemotron-3-super-120B-A12B-BF16.yaml) | nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-BF16 | Dense 120B reasoning/tool model, single node, requires shared parser plugin |
| [`minimax-m2.5.yaml`](_media/minimax-m2.5.yaml) | MiniMaxAI/MiniMax-M2.5 | MoE 230B, multi-node |
